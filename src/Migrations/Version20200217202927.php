 ...
 */
final class Version20200217202927 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE etudiant (id INT NOT NULL, compte_id INT NOT NULL, mail_perso VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE module (id INT NOT NULL, filiere_id INT NOT NULL, nom VARCHAR(255) NOT NULL, annee VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE etudiant ADD CONSTRAINT FK_717E22E3F2C56620 FOREIGN KEY (compte_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE prof ADD CONSTRAINT FK_5BBA70BBF2C56620 FOREIGN KEY (compte_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE admin ADD CONSTRAINT FK_880E0D76F2C56620 FOREIGN KEY (compte_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_880E0D76F2C56620');
        ...
        $this->addSql('ALTER TABLE admin ADD nom VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE admin ADD prenom VARCHAR(255) DEFAULT NULL');
